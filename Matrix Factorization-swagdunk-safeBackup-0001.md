...
3. **To predict a rating** you just take the _dot product_ of a user's vector and an item's vector (see maths section)
...
Regularised Square Error to learn factor vectors q_i and p_u
